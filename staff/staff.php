...
$sql = "SELECT st.id, st.name, st.address, st.contact, st.gender, st.shift, br.address as branch, st.experience FROM `staff` as st, branch as br WHERE st.branch_id = br.id";
...
<br><h1 style='margin-left: 66px'><b>Staff</b></h1><br></div>";
