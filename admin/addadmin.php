...
echo "<div class='container-fluidser' style='margin-left: 66px'><br><h1>Add admin details:</h1>";
echo "<form action='target_addadmin.php' method='POST'>
<br>
...
Date of Birth: <input type='text' name='dob' class='form-control'> <br>
Gender: <input type='text' name='gender' class='form-control'> <br>
City ID: <input type='text' name='city' class='form-control'> <br>
State ID: <input type='text' name='state' class='form-control'> <br>
Profile: <input type='text' name='profile' class='form-control'> <br>
